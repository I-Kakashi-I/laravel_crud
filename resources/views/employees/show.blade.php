            ...
            <h6 class="block mb-8 text-lg font-medium text-gray-900 dark:text-gray-300 text-center">View
                ...
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    <input type="text" id="name" name="name" value="{{$employee->name}}"
                           ...
                           placeholder="First Name - Second Name" disabled>
                </div>
                <div class="relative z-0 mb-6 w-full group">
                    <label for="email"
                ...
                <div class="relative z-0 mb-6 w-full group">
                    <label for="number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Phone Number</label>
                    <input type="tel" id="number" name="number" value="{{$employee->number}}"
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    <input type="text" id="address" name="address" value="{{$employee->address}}"
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                           placeholder="Street 1 Street 2" disabled>
                    <div class="relative z-0 mb-6 w-full group">
                        ...
                        <input type="text" id="position" name="position" value="{{$employee->position}}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               placeholder="Your Position" disabled>
                    </div>
                </div>
