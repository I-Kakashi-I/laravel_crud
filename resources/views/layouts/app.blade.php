...
<x-side-nav>
    ...
    <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="{{asset("images/Mangekyou_Sharingan_Kakashi.svg.png")}}" alt="Mangekyou_Sharingan_Kakashi"
                         class="h-8 w-8 items-center">&nbsp;&nbsp;
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kakashi</span>
                </a>
            </div>
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/"
                                                                                        class="hover:underline">Kakashi™</a>. All Rights Reserved.
        </span>
